 ...
 * CPE329 Assignment 6
 * Author: Lara Luu
 * Code samples taken from CPE329 cirriculum with Jeff Gerfen
 * https://polylearn.calpoly.edu/AY_2017-2018/pluginfile.php/285193/mod_resource/content/0/A6_DriveDAC_MSP432_starter_code.c
 */
...
/*
 * Note: Two interrupt handlers exist for generating a square wave and a triangle wave
 * Uncomment which function you want and comment the other to generate the waves
 */
